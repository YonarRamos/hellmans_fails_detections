          ...
          <v-layout row wrap>
            <v-flex xs5 text-xs-left pl-3 style="margin-top: 4px;">
              ...
              <h2 class="blue-grey--text">
                <strong>{{ 'Listado Monitoreo' }}</strong>
                &nbsp;&nbsp;
              </h2>
...
<script>
import Filtro from '@/components/public/monitoreo/Filtro'
import TablaMonitoreo from '@/components/public/monitoreo/TablaMonitoreo'
